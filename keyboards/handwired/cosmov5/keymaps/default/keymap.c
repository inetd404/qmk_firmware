...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NAVR] = LAYOUT(
    ...
    KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, KC_NA,              KC_CAPS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,
  ...
  [MOUR] = LAYOUT(
    ...
    KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, KC_NA,              KC_NU,   KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R,
    KC_NA,   KC_NA,   KC_NA,   KC_NA,   KC_NA,              KC_NU,   KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R,
             KC_NP,   KC_NA,   KC_NA,   KC_NA,              KC_BTN3, KC_BTN1, KC_BTN2, KC_NP
  ),
  [MEDR] = LAYOUT(
    KC_RST,  KC_NA,   KC_NA,   KC_NA,   KC_NA,              KC_NU,   KC_NU,   KC_NU,   KC_NU,   KC_NU,
    KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, KC_NA,              KC_NU,   KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT,
  ...
  [FUNL] = LAYOUT(
    ...
    KC_F11,  KC_F4,   KC_F5,   KC_F6,   KC_SCROLL_LOCK,     KC_NA,   KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI,
  ...
  [NSL] = LAYOUT(
    ...
    KC_SCLN, KC_4,    KC_5,    KC_6,    KC_EQL,             KC_NA,   KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI,
  ...
  [NSSL] = LAYOUT(
    ...
    KC_COLN, KC_DLR,  KC_PERC, KC_CIRC, KC_PLUS,            KC_NA,   KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI,
